...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        # Pet Image Label is NOT a Dog - counts number of NOT dog images
        else:
    ...
    # Calculates percentage of correctly matched images
    ...
    # Calculates percentage of correctly classified breeds of dogs
    if results_stats_dic['n_dogs_img'] > 0:
    ...
    # Calculates percentage of correctly classified NOT-a-dog images
    ...
    # Return the results_stats_dic containing all calculated statistics
